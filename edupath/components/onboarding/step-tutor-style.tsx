...
interface Props { values: OnboardingFormValues; errors: FormErrors; onChange: (patch: Partial<OnboardingFormValues>) => void; }
export function StepTutorStyle({ values, errors, onChange }: Props) {
