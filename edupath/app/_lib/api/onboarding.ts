...
export const MOCK_ROLE: Role = {
    ...
    skills: [
        { id: 'mock-sql', slug: 'sql', name: 'SQL', description: 'Query and combine tables to answer questions.', category: 'Data foundations' },
        { id: 'mock-spreadsheets', slug: 'spreadsheets', name: 'Spreadsheets', description: 'Formulas, pivot tables and quick analysis.', category: 'Data foundations' },
        { id: 'mock-relational-modeling', slug: 'relational-modeling', name: 'Relational modeling', description: 'Tables, keys and relationships.', category: 'Data foundations' },
        { id: 'mock-descriptive-statistics', slug: 'descriptive-statistics', name: 'Descriptive statistics', description: 'Summarize data with averages, spread and distributions.', category: 'Statistics' },
        { id: 'mock-probability', slug: 'probability', name: 'Probability', description: 'Reason about chance and uncertainty.', category: 'Statistics' },
        { id: 'mock-basic-python', slug: 'basic-python', name: 'Basic Python', description: 'Variables, loops, functions and data structures.', category: 'Programming' },
        { id: 'mock-pandas', slug: 'pandas', name: 'pandas', description: 'Load, transform and analyze tables in Python.', category: 'Programming' },
        { id: 'mock-basic-git', slug: 'basic-git', name: 'Basic Git', description: 'Commit, branch and collaborate on code.', category: 'Programming' },
        { id: 'mock-data-cleaning', slug: 'data-cleaning', name: 'Data cleaning', description: 'Fix missing, duplicated and inconsistent data.', category: 'Data preparation' },
        { id: 'mock-data-visualization', slug: 'data-visualization', name: 'Data visualization', description: 'Choose and build charts that tell the story.', category: 'Communication' },
        { id: 'mock-communicating-results', slug: 'communicating-results', name: 'Communicating results', description: 'Explain findings to non-technical people.', category: 'Communication' },
    ],
};
